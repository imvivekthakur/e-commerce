      ...
      <div className="container mx-auto p-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul>
              <li className="font-medium p-5 text-center hover:underline hover:cursor-pointer ">
                <Link to="/">Home</Link>
              </li>
              <li className="font-medium p-5 text-center hover:underline hover:cursor-pointer ">
          ...
          <div>
            ...
            <div className="flex mt-2">
              <input
                ...
                className="border rounded border-white p-2 mr-2 w-2/3  bg-transparent text-white border-none"
              />
              <button className="bg-white hover:bg-primary rounded-lg hover:text-white text-primary py-2 px-4 font-medium">
                Subscribe
              </button>
            </div>
          </div>
